...
public class Creature {
    ...
    public void moveBy(int mx, int my, int mz) {
        ...
        if (mz == -1) {
            if (tile == Tile.STAIRS_DOWN) {
                ...
                doAction("try to go up but are stopped by the dungeon ceiling");
                return;
            }
        } else if (mz == 1) {
            if (tile == Tile.STAIRS_UP) {
                ...
                doAction("try to go down but are stopped by the dungeon floor");
                return;
            }
        }
    ...
    private void throwAttack(Item item, Creature other) {
        ...
        other.addEffect(item.drinkEffect());
    }
    ...
    public void modifyFood(int amount) {
        ...
        if (food > maxFood) {
           ...
           if (!starving) {
               modifyAttackValue(-15);
               modifyDefenseValue(-15);
               starving = true;
           }
        }
        if (food > 1 && starving) {
